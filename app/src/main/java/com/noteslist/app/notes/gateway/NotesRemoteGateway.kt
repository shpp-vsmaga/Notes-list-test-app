...
interface NotesRemoteGateway {
     ...
     * @return [Flow] with actual list of notes from the remote repo
     */
     ...
     * @return [Note] model, that contains added text and generated id in
     * the remote repo
     */
     ...
     * @return [Note] model, that contains edited text
     */
